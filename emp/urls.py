...
urlpatterns = [
    ...
    path('jobs/mine/', views.JobOffersUserList.as_view(), name='job-mine'),
    re_path('^motivation_letters/(?P<pk>\d+)/$', views.MotivationLetterDetails.as_view(), name='mot-letter-details'),
    path('motivation_letters/', views.MotivationLetterUserList.as_view(), name='mot-letter-list'),
    re_path('^motivation_letters/delete/(?P<pk>\d+)/$', views.MotivationLetterDelete.as_view(), name='mot-letter-delete')
]